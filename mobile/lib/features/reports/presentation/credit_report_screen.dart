        ...
        data: (customers) {
          if (customers.isEmpty) {
            return EmptyState(
              ...
              title: context.tr('No outstanding credit', 'कुनै बाँकी उधारो छैन'),
              subtitle: context.tr('All customers are settled', 'सबै ग्राहकको हिसाब मिलेको छ'),
            );
          }
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(context.tr('Total Outstanding', 'कुल बाँकी उधारो'),
